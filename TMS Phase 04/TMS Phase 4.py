...
def searchTaskWin(wdMain):
    ...
    if os.path.exists(filename):
        ...
        btnTMS=Button(searchBody, text = 'Task Management System',command=lambda:[wdSearch.destroy(), wdMain.destroy(), mainmenuWin()], bg='#dcedc1')
...
def settingsWin(wdMain):
    ...
    btnTMS=Button(settingsBody,text = 'Task Management System',command=lambda:[wdSettings.destroy(), wdMain.destroy(), mainmenuWin()],bg='thistle')
    btnTMS.config(font=('Times New Roman',16))
    btnTMS.place(x=1,y=1)
